...
public class ShipmentServiceImpl implements ShipmentService {
    ...
    public ShipmentResponseDTO createShipment(ShipmentRequestDTO dto) {
        ...
        shipment.setSourceLocation(
                locationRepository.findById(dto.getSourceLocationId())
                .orElseThrow(() -> new ResourceNotFoundException("Source not found"))
        );

        shipment.setDestinationLocation(
                locationRepository.findById(dto.getDestinationLocationId())
                .orElseThrow(() -> new ResourceNotFoundException("Destination not found"))
        );

        shipment.setShipper(
                userRepository.findById(dto.getShipperId())
    ...
    private ShipmentResponseDTO map(Shipment s) {
        ...
        return ShipmentResponseDTO.builder()
                ...
                // NEW: Accepted Carrier Bid Amount
                .acceptedBidAmount(
                        s.getBids()
                        .stream()
